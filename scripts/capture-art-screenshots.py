...
def crop_to_target_aspect(source: Image.Image) -> Image.Image:
    ...
    At 200% scale the frame is already the exact 2926x1622. Cropping to the
    largest integral multiple of the target preserves the exact aspect ratio in
    both environments without resizing the live window.
    """
