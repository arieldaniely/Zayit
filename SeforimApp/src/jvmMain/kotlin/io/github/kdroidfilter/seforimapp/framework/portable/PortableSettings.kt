...
class PortableSettings(
    ...
    override fun getLong(key: String, defaultValue: Long): Long = getStringOrNull(key)?.toLongOrNull() ?: defaultValue
    ...
    override fun getFloat(key: String, defaultValue: Float): Float = getStringOrNull(key)?.toFloatOrNull() ?: defaultValue
    ...
    override fun getDouble(key: String, defaultValue: Double): Double = getStringOrNull(key)?.toDoubleOrNull() ?: defaultValue
    ...
    override fun getBoolean(key: String, defaultValue: Boolean): Boolean = getStringOrNull(key)?.toBooleanStrictOrNull() ?: defaultValue
